...
// RAW body for binary upload mode
...
// core processor used by both routes
async function processVideo(inFile, {probeSeconds=4}={}){
  ...
  if(!best) throw new Error("Could not detect crop");
...
// Binary upload mode (new) — send raw bytes
